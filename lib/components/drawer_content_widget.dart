  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ProfilesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProfilesRow> columnDrawerContentProfilesRowList = snapshot.data!;
        final columnDrawerContentProfilesRow =
            columnDrawerContentProfilesRowList.isNotEmpty
                ? columnDrawerContentProfilesRowList.first
                : null;
        return Column(
              ...
              child: Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'DRAWER_CONTENT_chevron_left_ICN_ON_TAP');
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            columnDrawerContentProfilesRow!.username!,
              ...
              children: [
                if (Theme.of(context).brightness == Brightness.light)
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'DRAWER_CONTENT_COMP_isLightMode_ON_TAP');
                ...
                if (Theme.of(context).brightness == Brightness.dark)
                  InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('DRAWER_CONTENT_COMP_isDarkMode_ON_TAP');
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'DRAWER_CONTENT_COMP_Row_kh05rt7d_ON_TAP');
                          ...
                          context.pushNamed(
                            ...
                            queryParameters: {
                              'userProfile': serializeParam(
                                columnDrawerContentProfilesRow,
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'DRAWER_CONTENT_COMP_Row_v1yirhru_ON_TAP');
                        logFirebaseEvent('Row_navigate_to');
            ...
            if (currentUserUid != null && currentUserUid != '')
              FutureBuilder<List<SettingsRow>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<SettingsRow> listViewSettingsRowList = snapshot.data!;
                  final listViewSettingsRow = listViewSettingsRowList.isNotEmpty
                      ? listViewSettingsRowList.first
                      : null;
                  return ListView(
                    padding: EdgeInsets.zero,
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    children: [
                      if (listViewSettingsRow?.showAbout ?? true)
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 1.0),
                          child: Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'DRAWER_CONTENT_COMP_Row_spcjbrkm_ON_TAP');
                                logFirebaseEvent('Row_navigate_to');

                                context.pushNamed('aboutSUAS');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                      ...
                      if (listViewSettingsRow?.showTeam ?? true)
                        Container(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          height: 50.0,
                          decoration: BoxDecoration(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'DRAWER_CONTENT_COMP_Row_j51d4h33_ON_TAP');
                              logFirebaseEvent('Row_navigate_to');
                      ...
                      Container(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'DRAWER_CONTENT_COMP_Row_4xi93sq1_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');

                            context.pushNamed('toc_privacy');
                          },
                          child: Row(
                            mainAxisSize: MainAxisSize.max,
                            children: [
              ...
              child: Row(
                ...
                children: [
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'DRAWER_CONTENT_COMP_LOG_OUT_BTN_ON_TAP');
