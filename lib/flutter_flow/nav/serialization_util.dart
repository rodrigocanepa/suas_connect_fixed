    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case UserFlagQueryplaceRow:
            return UserFlagQueryplaceRow(data);
          case PlacesRow:
          ...
          case ProfilesSensitiveRow:
            return ProfilesSensitiveRow(data);
          case CommentsRow:
            return CommentsRow(data);
          case UserBlocksRow:
            return UserBlocksRow(data);
          case FollowsUsersRow:
            return FollowsUsersRow(data);
          case SettingsRow:
            return SettingsRow(data);
          case ProfilesRow:
            return ProfilesRow(data);
          case SuasTeamRow:
            return SuasTeamRow(data);
          case UserPlacesRow:
            return UserPlacesRow(data);
          case UserVotesRow:
            return UserVotesRow(data);
          case CategoriesRow:
            return CategoriesRow(data);
          case QueryUserPlacesRow:
            return QueryUserPlacesRow(data);
          default:
            return null;
        }
